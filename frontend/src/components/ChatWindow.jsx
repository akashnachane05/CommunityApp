...
export default function ChatWindow({ receiver, onClose }) {
    ...
    useEffect(() => {
        ...
        // Function to clear notifications for the person you're chatting with
        const clearNotifications = async () => {
            try {
                // This API call tells the backend to delete all notifications from this sender
                await api.delete(`/notifications/sender/${receiver._id}`);
            } catch (error) {
                console.error("Failed to clear notifications for sender:", error);
            }
        };
        ...
        const initializeChat = async () => {
            try {
                ...
                // ✅ THE FIX: Call the clearNotifications function as soon as the chat is loaded
                clearNotifications();
    ...
    const handleSendMessage = async (e) => {
        ...
        setMessages((prev) => [...prev, { sender: { _id: user._id }, text: newMessage }]);
