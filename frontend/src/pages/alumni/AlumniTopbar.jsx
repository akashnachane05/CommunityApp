...
import NotificationDropdown from '../../components/NotificationDropdown'; // ✅ Import the new NotificationDropdown component
// Accept the setActiveTab prop
const AlumniTopbar = ({ onToggleChatbot, setActiveTab,onNotificationClick }) => {
