...
import { Home, Users, Award, Calendar, Briefcase, MessageCircle, BookOpen, User, LogOut, ArrowRight, X } from 'lucide-react';
import { Button } from '../../components/ui/button';
import { cn } from '../../lib/utils';

const StudentSidebar = ({ isCollapsed, onToggle, activeTab, setActiveTab, logout }) => {
  const navItems = [
    { name: 'Dashboard', icon: Home, tab: 'dashboard' },
    { name: 'Alumni Network', icon: Users, tab: 'alumni' },
    { name: 'Mentorship', icon: Award, tab: 'mentorship' },
